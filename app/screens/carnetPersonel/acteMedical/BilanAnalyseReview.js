...
export default function BilanAnalyseReview({route, navigation }){
    ...
    return(
        <View style={globalStyles.container}>
         ...
         <View style={styles.container}>
         <Text style={styles.display1}>Bilan Analyse : </Text>
         <Text style={styles.display}>{ route.params.image}</Text>
         </View>
